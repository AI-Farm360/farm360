      ...
      >
        <div className="space-y-8 bg-white border border-brand-border rounded-3xl p-6 md:p-10 shadow-[0_12px_40px_rgba(23,23,23,0.02)]">
          <div className="pb-4 border-b border-brand-bg flex items-center justify-between">
            ...
            <button onClick={() => router.push('/dashboard')} className="text-xs text-brand-muted hover:text-brand-text border border-brand-border bg-brand-bg px-3.5 py-1.5 rounded-full transition-all cursor-pointer">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-2">
                  {[
                    ...
                    return (
                      <button key={item.rating} type="button" onClick={() => setFeedbackRating(item.rating as any)}
